...
def get_megatron_sharded_states(args, tp_size, pp_size, pp_rank):
    ...
    for i in range(tp_size):
        ...
        state_dict = torch_xla.utils.serialization.load(checkpoint_path)
...
def convert_checkpoint_from_megatron_to_transformers(args):
    ...
    #     openai_gelu=False,
    #     padded_vocab_size=state_dict['padded_vocab_size'],
    #     max_position_embeddings=state_dict['max_position_embeddings'],
    #     hidden_size=state_dict['hidden_size'],
    #     num_layers=state_dict['num_layers'],
    #     num_attention_heads=state_dict['num_attention_heads'],
    #     ffn_hidden_size=4096,
    #     tensor_model_parallel_size=state_dict['tensor_model_parallel_size'],
    #     pipeline_model_parallel_size=state_dict['pipeline_model_parallel_size'],
    # )
    megatron_args = argparse.Namespace(
        ffn_hidden_size=state_dict['ffn_hidden_size'],
        hidden_size=state_dict['hidden_size'],
        num_layers=state_dict['num_layers'],
        num_attention_heads=state_dict['num_attention_heads'],
        max_position_embeddings=state_dict['max_position_embeddings'],
        ...
        pipeline_model_parallel_size=state_dict['pipeline_model_parallel_size'],
        tensor_model_parallel_size=state_dict['tensor_model_parallel_size'],
        bias_gelu_fusion=state_dict['bias_gelu_fusion'],
        openai_gelu=state_dict['openai_gelu'],
    )
